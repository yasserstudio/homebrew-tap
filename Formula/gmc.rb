...
class Gmc < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "df86d5f78b6fcb5bf07ca3915e88fb67f928a02210303dd7b851c9b51be40d25"
    end
    on_intel do
      url "https://github.com/yasserstudio/gmc/releases/download/v#{version}/gmc-darwin-x64"
      sha256 "7342e8711034ba6f00e6fb6a9808016b2bc0cb51a835c172d05ed8e647a1f084"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "d1809b5c2ac593d24ca6f448a64f624b26b8aaf0f23e0bb8aa6e190cb40ca075"
    end
    on_intel do
      url "https://github.com/yasserstudio/gmc/releases/download/v#{version}/gmc-linux-x64"
      sha256 "946c4b4cf521974bd23b0fc19c91e4ba7061303dce7c5bc5907fac6394d67336"
    end
  end
